...
import com.dy.restaurant.account.repository.OAuthClientRepository;
...
public class AuthServiceImpl implements AuthService {
  ...
  public CreateUserResponse registerUser(SignUpRequest signUpRequest) {
    ...
    com.dy.restaurant.account.repository.dao.User user =
        new com.dy.restaurant.account.repository.dao.User(
    ...
    com.dy.restaurant.account.repository.dao.User savedUser =
